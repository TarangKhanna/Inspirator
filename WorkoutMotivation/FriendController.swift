...
let reuseIdentifier3 = "CellFriend"

class FriendController: UICollectionViewController, UICollectionViewDelegateFlowLayout, UIPopoverPresentationControllerDelegate {
